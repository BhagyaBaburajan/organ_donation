...
<body class="w3-light-grey">
	...
	<nav class="w3-sidenav w3-collapse w3-white w3-animate-left"
		...
		<!-- side nave login -->
		<c:import url="WEB-INF/tiles/donor/index_login_nav.jsp" />

		<!-- menu nav -->
		<c:import url="WEB-INF/tiles/donor/index_menu_nav.jsp" />
	</nav>
	...
	<div class="w3-main" style="margin-left: 300px; margin-top: 43px;">
		...
		<!-- Header -->
<%-- 		<c:import url="WEB-INF/tiles/donor/insideDonorDetails.jsp" /> --%>
		<c:import url="WEB-INF/tiles/donor/index_content.jsp" />
