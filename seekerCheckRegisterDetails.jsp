...
<%
	...
	if (bean != null) {
		...
		if (status != 0) {
			response.sendRedirect("seekerInsideDetails.jsp");//  already registerd just redirect field
		} else {
			response.sendRedirect("seekerRegisterDetails.jsp?organ_id="+organ_id+"&organ_name="+organ_name);
		}
	} else {
